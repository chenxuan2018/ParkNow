...
public class MainActivity extends AppCompatActivity {
    ...
    //This function will direct user to - South Garage
    ...
    // This function will direct user to - North Garage
    ...
    //This function will direct user to - West Garage
    ...
    //This function will direct user to - Park N' Ride
    public void browserP(View v) {
    ...
    //This function will direct user to - SJSU.edu web
    //Providing additional feature for users
    ...
    public void Login(View v) {
        Toast myToast = Toast.makeText(getApplicationContext(), "Directing to Login Page", Toast.LENGTH_LONG);
        myToast.show();
